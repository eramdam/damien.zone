...
On iOS, [Arpeggi](https://testflight.apple.com/join/LDWqgjAs) has been my daily driver. It looks nice, fits pretty well on iOS, and the transcoding feature is _very_ handy when on a cellular network[^4], I'll happily pay for it (even with a subscription) when it officially comes out.
