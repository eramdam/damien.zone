...
[macthemes.garden](https://macthemes.garden) - [Mastodon bot](https://social.erambert.me/@macthemes) - [Bluesky bot](https://bsky.app/profile/macthemes.bsky.social) - [https://github.com/eramdam/macthemes.garden](https://github.com/eramdam/macthemes.garden) - [Blog post](/introducing-mac-themes-garden)

![Mac Themes Garden](/img/projects/macthemes-garden.webp)

_Mac Themes Garden_ is a website showcasing more than (at the time of writing) 3,900 Kaleidoscope schemes from the late 90s to the early 2000s. A perfect excuse to indulge in some retro web design and CSS trickery to mimic the Mac OS 9 UI.

## Sticky Fingers

[https://github.eramdam/sticky-fingers](https://github.eramdam/sticky-fingers) - [Blog post](/modding-balatro-on-pc-to-add-touch-controls)

![](/img/blog/balatro-touch/sticky-fingers-hero.webp)

A mod for [Balatro](https://www.playbalatro.com/) that adds drag'n'drop controls to the PC version.
